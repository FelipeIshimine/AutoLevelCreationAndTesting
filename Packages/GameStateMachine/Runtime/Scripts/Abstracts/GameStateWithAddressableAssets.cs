...
{
    public abstract class GameStateWithAddressableAssets<T> : GameState<T>, IReleaseAddressable where T : GameStateWithAddressableAssets<T>
    {
        ...
        protected GameStateWithAddressableAssets()
        {
        ...
        public void Release(SelfReleaseAddresable selfReleaseAddresable)
        {
        ...
        private void InstantiationDone()
        {
            ...
            {
                IUse<T> iUse = gameObject.GetComponent<IUse<T>>();
                if (iUse != null)
                    iUse.GameState = this as T;
            }
    ...
    public interface IReleaseAddressable
    {
        void Release(SelfReleaseAddresable selfReleaseAddresable);
    }
}
