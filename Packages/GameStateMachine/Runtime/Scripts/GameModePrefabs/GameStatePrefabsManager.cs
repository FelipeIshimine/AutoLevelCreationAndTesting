...
namespace GameStateMachineCore
{
    ...
    public class GameStatePrefabsManager : ScriptableObject
    {
        ...
        {
            IEnumerable<Type> subclassTypes = from assembly in AppDomain.CurrentDomain.GetAssemblies()
        ...
        internal static GameStatePrefabReferences GetPrefabReferences(BaseGameState gameState)
        {
